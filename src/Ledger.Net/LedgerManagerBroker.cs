...
namespace Ledger.Net
{
    public class LedgerManagerBroker : IDisposable
    {
        ...
        {
            new FilterDeviceDefinition{ DeviceType= DeviceType.Hid, VendorId= 0x2c97, UsagePage=0xf1d0 },
            new FilterDeviceDefinition{ DeviceType= DeviceType.Hid, VendorId= 0x2581, ProductId=0x3b7c, UsagePage=0xf1d0 },
            //Android only
            new FilterDeviceDefinition{ DeviceType= DeviceType.Usb, VendorId= 0x2c97, UsagePage=0xf1d0 },
            new FilterDeviceDefinition{ DeviceType= DeviceType.Usb, VendorId= 0x2581, ProductId=0x3b7c, UsagePage=0xf1d0 },
       };
